...
ecoli_initial_4c_7_2_24 = {
    "minute": [0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240],
    "total_volume": [4],
    "1": [None, .03, .015, .110, .13, .1, .18, .21, .23, .37, .53, .63, .72],
    "2": [None, .007, .28, .274, .3, .28, .3, .34, .37, .37, .9, 1.01,1.2],
    "3": [None, .002, .02, .07, .12, .14, .17, .24, .28, .3, .45, .53, .66],
}
...
# Figure 2: Growth curves of E. coli DH5a grown in LB medium for 8 h shaking at 
# 180 pm at 37 °C. Every 60 min the OD600 of the same sample was measured in 
# three different photometers showing that the results differ when comparing 
# different instruments. The samples were diluted using LB medium when an 
# absorbance value of 0.8 was reached to guarantee accurate measuring at 600 nm. 
# The dilution factor was used to multiply with the measured result for absorbance 
# value determination.
eppendorf_data = {
    "minute": [0, 60, 120, 180, 240, 300, 360, 420, 480],
    "total_volume": [4.2],
